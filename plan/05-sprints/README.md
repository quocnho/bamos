...
| Sprint | Goal | Dates | SP | Status | Git Branch | Release |
|--------|------|-------|-----|--------|------------|---------|
| [Sprint 1](sprint-01-iso-gnome-standard/) | ISO GNOME Standard bootable | 07-03 → 07-03 | 34/37 | 🟢 Done | `sprint/01/iso-gnome-standard` | v0.1.0 |
...
|--------|---------|-----------|----------|-------|
| Sprint 1 | 37 SP | 34 | 91% | First ISO build |
| Sprint 2 | 30 SP | 30 | 100% | KDE + Standard apps |
| Sprint 3 | 35 SP | 35 | 100% | Dev + Gaming editions |
| Sprint 4 | 35 SP | 35 | 100% | COSMIC + Studio |

---

## All Sprints Completed (1-4)

| Sprint | Tag | Key Deliverables |
|--------|-----|------------------|
| v0.1.0 | ISO GNOME Standard | Calamares, Disko, Cachix, CI/CD |
