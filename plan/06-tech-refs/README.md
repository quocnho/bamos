...
This directory contains technology assessment documents produced by the `tech` skill and the `init` skill.
...
| Mirror Strategy | CDN vs self-hosted mirror tại Việt Nam? | 🔵 Low |

## Instructions for tech skill
When analyzing technologies for BamOS:
1. Save assessments here as `tech-assessment-<topic>.md`
2. Update this README with links to new assessments
3. Signal the `plan` and `dev` skills that new tech context is available
