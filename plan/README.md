...
| [03 — Roadmap](03-roadmap/) | Technical roadmap (12 phases) and milestones | 🟢 Complete |
| [04 — Backlog](04-backlog/) | Epics (10), user stories (40+), ICE scoring | 🟢 Complete |
...
| [07 — Increment](07-increment/) | Release notes and delivered increments | 🟢 Complete |
...
3. **Journey** → [03 — Roadmap](03-roadmap/) — 12 phases với milestones chi tiết
4. **Now** → [05 — Sprint Dashboard](05-sprints/README.md) — 🔥 Tất cả sprints trong một glance
5. **Details** → [04 — Backlog](04-backlog/) — User stories đã được ICE-scored
6. **Stack** → [06 — Tech Refs](06-tech-refs/) — Technology rationale & key decisions
7. **Releases** → [07 — Increment](07-increment/) — Release notes
...
| [Sprint 5](05-sprints/sprint-05-auto-detect-theming/) | Auto-Detect + RakuOS Theming | 07-06 → 07-06 | — | 🟢 Done |
