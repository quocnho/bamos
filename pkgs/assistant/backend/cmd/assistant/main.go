...
import (
	...
	"bamos-assistant/backend"
	"bamos-assistant/backend/internal/delivery/gui"
	"bamos-assistant/backend/internal/platform/linux"
...
func main() {
	fmt.Println("==================================================")
	fmt.Println("🐶 BamOS Mascot AI Assistant (Clean Architecture)")
	fmt.Println("==================================================")
